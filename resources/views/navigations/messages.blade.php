<div class="font-sans container">
    ...
    <div class="w-full md:w-4/5 mx-auto p-5">
        <p class="pb-2" style="font-family: 'Tangerine', cursive;font-size:27px">My <strong>messages</strong></p>
        <div class="text-sm">
           <div class="tab w-full overflow-hidden border-t">
              <input class="absolute opacity-0 " id="tab-multi-one" type="checkbox" name="tabs">
              <label class="block p-5 leading-normal cursor-pointer" for="tab-multi-one">Fredrick</label>
              <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal overflow-scroll">
               
               <div class="flex-1 p:2 sm:p-4 justify-between flex flex-col">
                  ...
                  <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                     <div class="relative flex">
                        ...
                        <input type="text" placeholder="Write Something" class="w-full h-10 focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-full py-3">
                        <div class="absolute right-2 items-center inset-y-0 hidden sm:flex">
                           ...
                           <button type="button" class="inline-flex items-center justify-center rounded-full h-8 w-8 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
           ...
           <div class="tab w-full overflow-hidden border-t">
              ...
              <label class="block p-5 leading-normal cursor-pointer" for="tab-multi-two">Rogath</label>
           ...
           <div class="tab w-full overflow-hidden border-t">
              ...
              <label class="block p-5 leading-normal cursor-pointer" for="tab-multi-three">Shayo</label>
              <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                 <p class="p-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</p>
              </div>
           </div>
